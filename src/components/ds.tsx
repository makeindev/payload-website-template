...
export const Container = ({ children, className, id, style }: DSProps) => (
  <div className={cn('mx-auto max-w-7xl p-2 sm:p-6', className)} id={id} style={style}>
    {children}
  </div>
)
...
export const Nav = ({ children, className, containerClassName, id, style }: DSProps) => (
  <nav className={cn(className)} id={id} style={style}>
    <div
      id="nav-container"
      className={cn('mx-auto max-w-5xl px-4 py-3 sm:px-6', containerClassName)}
    >
      {children}
    </div>
  </nav>
